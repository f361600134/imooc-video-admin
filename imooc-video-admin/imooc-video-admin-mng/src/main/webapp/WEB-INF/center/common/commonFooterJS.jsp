...
<input type="hidden" id="apiServer" name="apiServer" value="http://39.108.222.184:8081"/> 
<input type="hidden" id="bgmServer" name="bgmServer" value="http://39.108.222.184:8080/mvc"/>
